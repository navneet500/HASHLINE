...
baselines = r"C:\Users\navne\Desktop\Baselines"#Baseline.txt will be at this specified path
secure_path = ""
...
root.wm_iconphoto(False,tk.PhotoImage(file="icons/window_icon.png"))
...
browse_btn = ctk.CTkButton( master=root,
                            text="Browse",
                            image=tk.PhotoImage(file="icons/browse.png").subsample(10,10), 
                            compound=ctk.RIGHT,
                            command=open_file,
                            fg_color=btn_fg_clr,
...
update_baseline_btn = ctk.CTkButton( master=root,
                                     ...
                                     image=tk.PhotoImage(file="icons/updatebaseline.png").subsample(18,18), 
                                     compound=ctk.RIGHT,
...
check_integrity_btn = ctk.CTkButton( master=root,
                                     ...
                                     image=tk.PhotoImage(file="icons/checkintegrity.png").subsample(9,9), 
                                     compound=ctk.RIGHT,
